...
#https://github.com/JJHyeok-99/OpenSource-Assignment2.git
...
def dataset_stat(dataset_df):
	n_feats = list(dataset_df.columns.values)
	classes = data_df.groupby("target").size()

	return len(n_feats) - 1, classes[0], classes[1]
